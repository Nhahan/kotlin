package com.delivery.repository.order

import com.delivery.domain.order.OrderStatus
import com.delivery.domain.order.OrderStore
...
interface OrderRepository: JpaRepository<Order, Long> {
    @Query(
        value = """
            SELECT new com.delivery.domain.order.OrderStore(o.orderId, o.orderStatus, o.totalAmount, o.discountAmount, s.storeId, s.storeName)
            FROM Order as o
    ...
    @Query(
        value = """
            SELECT new com.delivery.domain.order.RecentOrderStore(o.orderId, o.orderStatus, s.storeId, s.storeName, s.reviewGrade, s.deliveryTime, s.deliveryFee, s.storeMainImageUrl)
            FROM Order as o
            JOIN Store as s ON o.storeId = s.storeId
